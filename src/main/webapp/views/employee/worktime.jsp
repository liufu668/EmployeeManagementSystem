        ...
        <div class="layui-col-md10">
            ...
            <div  class="grid-demo layui-col-md3">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                    <input type="text" name="checkTime" id="checkTimeSearch" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
...
<div style="display: none" id="imitateCheck">
    <form class="layui-form" action="" lay-filter="imitateCheckForm" id="imitateCheckForm">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="dept" lay-filter="dept"  class="dept" id="imitateDept" required  lay-verify="required">
                    <option value="">选择部门</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="employeeId"lay-filter="employee" class="employeeImitate" required  lay-verify="required">
                    <option value="">选择员工</option>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="checkTime" required lay-verify="required" id="checkTime" placeholder="yyyy-MM-dd HH:mm:ss" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div>
            <button type="button" data-method="imitateCheck"  lay-filter="formVerify" lay-submit style="display: none">提交打卡表单</button>
        </div>
    </form>
</div>
<script>
    layui.use(['table','layer','form','laydate'], function() {
        ...
        var workTable =  table.render({
            ...
            ,cols: [[
                ...
                ,{width:160, title: '操作',templet:function(d){
                        var btnStr = ' <button type="button" class="layui-btn layui-btn-sm singleBtn" data-method="changeStatus" data-id="'+ d.id+'">改为正常</button>' +
                                     '<button type="button" class="layui-btn layui-btn-sm singleBtn" data-method="deleteRecord" data-id="'+d.id+'"><i class="layui-icon layui-icon-delete"></i></button>';;
                    return  btnStr;
                }}
            ]],
