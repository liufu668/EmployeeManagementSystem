...
<div hidden id="addEmployee">
    <form class="layui-form" action="" lay-filter="addEmployeeForm" id="addEmployeeForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="politicalStatus" lay-filter="politicalStatus">
                    <option value=""></option>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">部门</label>
            <div class="layui-input-block">
                <select name="dept" lay-filter="dept"  class="dept" required  lay-verify="required">
                    <option value="">选择部门</option>
                </select>
            </div>
        </div>
        <div>
            <button type="button" data-method="addEmployee" lay-filter="formVerify" lay-submit style="display: none">提交新员工表单或者修改后的员工表单</button>
        </div>
    </form>
</div>
<script>
    layui.use(['table','layer','form','laydate'], function(){
        ...
        form.verify({
            email: function (value) {
                //邮箱的基本格式为“名称@域名”,名称和域名都必须是大小写字母或数字或下划线,不能是其他
                //使用“^”匹配邮箱的开始部分，用“$”匹配邮箱结束部分
